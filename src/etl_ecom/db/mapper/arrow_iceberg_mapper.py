...
from pyiceberg.types import BooleanType, DateType, DecimalType, DoubleType, IntegerType, LongType, NestedField, StringType, TimestampType
...
def arrow_to_iceberg_schema(arrow_schema):
    ...
    for idx, field in enumerate(arrow_schema, start=1):
        ...
        # ENUM postgres / dictionary
            ...
            logger.warning(
                f"⚠️ Type inconnu {field_type}, fallback STRING"
            )
            iceberg_type = StringType()
