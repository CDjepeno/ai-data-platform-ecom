...
def make_use_case(
    ...
    return use_case, infra, validator, loader, semantic


class TestRunPipelineUseCase:

    def test_full_pipeline_runs_all_steps(self):
        use_case, infra, validator, loader, semantic = make_use_case()
    ...
    def test_skips_pipeline_when_already_initialized(self):
        use_case, infra, validator, loader, semantic = make_use_case(initialized=True)
    ...
    def test_raises_and_stops_when_schema_drift_detected(self):
        use_case, _, _, loader, semantic = make_use_case(schema_raises=True)
